# Bractwo — Pogranicze · 0.5.0 — Żywe Pogranicze
...
- **9 nowych przeciwników:** bandyta łucznik, szkielet łucznik, plujący pająk, cyklop, niedźwiedź, harpia, ghul, ogr i skorpion. Łącznie 48 typów faktycznie występujących w świecie.
...
**Aktualizuj jednocześnie serwer i klienta.** Zatrzymaj starą wersję i skopiuj jej bazę `data/world.sqlite3` do nowej paczki, zachowując kopię zapasową. Konta i postęp 0.3–0.4.1 są zachowane. Jeśli nowa przeszkoda pokrywa zapisane miejsce postaci, ponowne logowanie poza blokadą walki przeniesie ją do Przystani.
...
- **11 podziemi po 2 piętra:** kopalnie, groty, twierdza, piramida, krypty, pałac lodu, smocze gniazdo i otchłań. Schody mają rzeczywiste przejścia i powrót; ściany zatrzymują ruch oraz ataki.
...
**60 testów serwera oraz 7 testów logiki JS przeszło.** Python i JS zgodnie rozpoznają podłoże w tysiącach punktów rzeczywistej mapy. Sprawdzono składnię JS, Python i wszystkich 7 skryptów GDScript. Szczegóły: `docs/TEST_REPORT.md`.
